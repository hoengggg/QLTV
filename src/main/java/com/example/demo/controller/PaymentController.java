...
public class PaymentController {
    ...
    public String getAll(Model model){
        model.addAttribute("listPayment", repoPayment.findAll());
    ...
    public String search(@RequestParam("method") String method, Model model){
        model.addAttribute("listPayment", repoPayment.findByMethodContaining(method));
        return "Payment/payment_hien_thi";
    }
